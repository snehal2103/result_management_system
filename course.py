...
class CourseClass:
    def __init__(self,root):
        ...
        self.txt_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,'bold'),bg='lightblue')
        self.txt_duration.place(x=150,y=100,width=200)
        self.txt_charges=Entry(self.root,textvariable=self.var_charges,font=("goudy old style",15,'bold'),bg='lightblue')
        ...
        txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='lightblue')
    ...
    def delete(self):
        ...
        try:
            if self.var_course.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Please select the course from list first",parent=self.root)
                else:
